...
local function get_footer()
    local footer = {
        "",
        "",
        string.format("Lazy took %s ms to start with %s plugins", require("lazy").stats().startuptime, require("lazy").stats().loaded),
        string.format("%s plugins are currently not loaded", require("lazy").stats().count - require("lazy").stats().loaded),
    }
        ...
        config = {
            ...
            shortcut = {
                ...
                },
                {
                    ...
                    action = "", -- TODO: Add telescope command to open files in current path
                    key = "f",
                },
                {
                    icon = " ",
                    desc = "Config",
                    group = "DiagnosticVirtualTextInfo",
                    action = "", -- TODO: Add telescope command to open neovim config files
                    key = "c",
                },
                {
                    icon = "󰆓 ",
            ...
            project = {
                ...
                action = "Telescope find_files cwd=", -- TODO: Add correct telescope command to open files in specified directory
            },
